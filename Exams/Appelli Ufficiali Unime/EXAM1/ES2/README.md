...
Creare una classe `GestoreEccezioni` contenente un metodo `public void processa(int valore)`. All'interno di questo metodo (o aiutandoti con altri se necessario), implementare la logica per gestire i seguenti casi basati sul parametro `valore`:
