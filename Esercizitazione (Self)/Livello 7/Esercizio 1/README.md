# Esercizio 1: Creazione Progetto con Maven / Exercise 1: Project Creation with Maven
...
### Syllabus
Use the `mvn archetype:generate` command from the terminal to generate the standard structure of a Java project with the `pom.xml` file.
